...
Project developed during RocketSeat's OmniStack 9.0 Week, based on the NodeJs, ReactJs and React Native stack. It was based on an Airbnb clone to post / find reservations at companies that rent or provide space for devs from other companies.
